...
<head>
    ...
    <title>Documents | Association of T-11 Surveyors</title>
...
<body>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php
                        ...
                        <ul class="dropdown-menu">
                            <li  class="active"><a href="docs.php">Documents</a></li>
    ...
    <section id="about-us" class="container">
        <div class="row">
            <div class="col-sm-6">
                <a href="docs/BR15.pdf">
                    <h4>Budget Report 2015</h4>
                </a>
                <a href="docs/MF15.pdf">
                    <h4>Membership Fees for the Year 2015</h4>
                </a>
                <a href="docs/MF16.pdf">
                    <h4>Membership Fees for the Year 2016</h4>
                </a>
                <a href="docs/WF16.pdf">
                    <h4>Welfare Collections for the Year 2016</h4>
                </a>
                <a href="docs/160102.pdf">
                    <h4>Budget of the 36th Anniversary and Opening Ceromony (සිංහල)</h4>
                </a>
                <a href="docs/160102EN.pdf">
                    <h4>Budget of the 36th Anniversary and Opening Ceromony (English)</h4>
                </a>
                <a href="docs/gdaksunil.pdf">
                    <h4>Donations made for L/S Mr. G.D.A.K. Sunil</h4>
                </a>
                <a href="docs/sbhemasiri.pdf">
                    <h4>Donations made for L/S Mr. S.B. Hemasiri</h4>
                </a>
                <a href="docs/sb.pdf">
                    <h4>Donations made for L/S Mr. S.B. Abeysinghe</h4>
                </a>
            </div><!--/.col-sm-6-->
            <div class="col-sm-6">
