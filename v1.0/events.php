...
<head>
    ...
    <title>Events | Association of T-11 Surveyors</title>
...
<body>
    ...
    <section id="about-us" class="container">
        <div class="row">
            <div class="col-sm-6">
                    <a data-toggle="modal" data-target="#open">
                        <h4>Opening Ceremony of the Official Website</h4>
                    </a>
            </div><!--/.col-sm-6-->
            <div class="col-sm-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-24 col-md-12">
                        <div class="container">
                            <h2>Opening Ceremony of the Official Website</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-24 col-md-12">
                        <div class="container">
                            <table class="table table-stripped">
                                <tr>
                                    <td><b>Venue</b></td>
                                    <td>Hotel Sunrich, Kurunegala Road, Hedeniya, Werellagama, Kandy.</td>
                                </tr>
                                <tr>
                                    <td><b>Time</b></td>
                                    <td>9.00 a.m.</td>
