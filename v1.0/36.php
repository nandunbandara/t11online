...
<head>
    ...
    <title>36th Anniversary and Opening Ceromony | Association of T-11 Surveyors</title>
...
<body>
    ...
    <section id="title" class="emerald">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1>36th Anniversary and Opening Ceromony</h1>
                </div>
                <div class="col-sm-6">
                    <ul class="breadcrumb pull-right">
                        <li><a href="index.php">Home</a></li>
                        <li><a href="videos.php">Videos</a></li>
                        <li class="active">36th Anniversary and Opening Ceromony</li> 
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section id="about-us" class="container">
        <div class="row">
            <div class="col-sm-6">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/NWXOs4EuhGg" frameborder="0" allowfullscreen></iframe>
            </div><!--/.col-sm-6-->
            <div class="col-sm-6">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/At5HGifhnDY" frameborder="0" allowfullscreen></iframe>
            </div><!--/.col-sm-6-->
        </div><!--/.row-->
        <div class="row">
            <div class="col-sm-6">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/iMDf8LoHxlg" frameborder="0" allowfullscreen></iframe>
            </div><!--/.col-sm-6-->
            <div class="col-sm-6">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/NyC1BaEn3Pc" frameborder="0" allowfullscreen></iframe>
            </div><!--/.col-sm-6-->
        </div><!--/.row-->
        <div class="row">
            <div class="col-sm-6">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/XIWyeUu2aQ8" frameborder="0" allowfullscreen></iframe>
            </div><!--/.col-sm-6-->
            <div class="col-sm-6">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/27O1KQUIcHY" frameborder="0" allowfullscreen></iframe>
            </div><!--/.col-sm-6-->
        </div><!--/.row-->
        <div class="row">
            <div class="col-sm-6">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/vlReyYKoMyA" frameborder="0" allowfullscreen></iframe>
            </div><!--/.col-sm-6-->
            <div class="col-sm-6">
